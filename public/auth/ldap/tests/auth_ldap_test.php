...
final class auth_ldap_test extends \advanced_testcase {
     ...
     * request in one shot.
     *
     * @covers \auth_plugin_ldap::map_ldap_entry_to_userinfo
     * @covers \auth_plugin_ldap::ldap_get_search_attributes
     */
     ...
     *
     * @covers \auth_plugin_ldap::get_userinfo
     */
     ...
     *
     * @covers \auth_plugin_ldap::get_preloaded_userinfo_for_chunk
     */
     ...
     *
     * @covers \auth_plugin_ldap::update_users
     */
     ...
     *
     * @covers \auth_plugin_ldap::asynchronous_sync_task
     */
